        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             A passionate Software Developer specializing in building innovative, functional, and user-friendly web and AI-driven applications. I love turning complex problems into simple, elegant solutions and creating digital experiences that are both interactive and impactful. Constantly exploring the latest in frontend, backend, and AI technologies, I strive to craft applications that make a real difference.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          &quot;I don&apos;t just write code—I build innovative, intelligent, and impactful solutions.&quot;
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1lonodYVcAeoxGjrY3OgIQ9J2IVd068gQ/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
