...
const MainTitle = memo(function MainTitle() {
  return (
    <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-tight leading-tight">
...
const WORDS = ["Frontend & Backend Development", "AI/ML Enthusiast"]
const TECH_STACK = ["AI Explorer", "Tech Trailblazer", "Next Gen Developer"]
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Alisha-21-cloud" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/syed-ahmad-alisha/" },
   { icon: SiLeetcode, link: "https://leetcode.com/u/22A31A4256/" }, // replaced Instagram with LeetCode
]
    ...
    >
      ...
      >
        <div className="container mx-auto min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 sm:gap-12 lg:gap-20 py-10">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-center lg:text-left order-1 lg:order-1"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Innovating the Web with Functional, Interactive, and AI-Powered Solutions.
                </p>
